        ...
        implements QueryManager
{
    ...
    /**
     * CreateTable，RenameTable 等 DDL 操作的 sql 语句对应的是 DataDefinitionExecutionFactory
     * 非 DDL 操作的 sql 语句例如 select，insert 对应的是
     */
    ...
    public QueryInfo createQuery(Session session, String query)
    {
        ...
        try {
            ...
            // 根据获取的 statement 类型，获取对应的 QueryExecutionFactory
