...
public class TaskResource
{
    ...
    public Response createOrUpdateTask(@PathParam("taskId") TaskId taskId, TaskUpdateRequest taskUpdateRequest, @Context UriInfo uriInfo)
    {
        ...
        // 若存在 taskId 对应的task，就根据 taskUpdateRequest 中的内容更新这个 task，否则就根据 taskUpdateRequest 创建一个新的 task
    ...
    /**
     * 获得 taskId 指定的 task 生成的用于输出到某个下游 Task 的数据
     * @param taskId
     * @param outputId
     * @param token
     * @param asyncResponse
    ...
    /**
     * 清除 taskId 表示的 Task 生成的用于输出给下游 Task （该 Task 由 outputId 标示）的数据
     * @param taskId
     * @param outputId
     * @param uriInfo
     * @return
