        ...
        implements Closeable
{
    ...
    {
        // session.gerServer() 获取启动 cli 客户端时通过参数 --server 指定的 Coordinator 地址
    ...
    public boolean advance()
    {
        ...
        // 如果查询结果已经全部返回，则 Coordinator 会将 nextUri 设置为 NULL
    ...
    private void processResponse(JsonResponse<QueryResults> response)
    {
        ...
        // 将返回的结果设置到 client 端的 currentResults 中，
